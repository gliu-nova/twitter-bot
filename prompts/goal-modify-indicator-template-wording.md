# goal-modify-indicator-template-wording
...
1. What happened?
2. Why is it unusual?
3. Why should a trader/investor care?

## Implementation

Runtime templates live in `src/posting/compose.py` (`compose_single_tweet`, `compose_multi_tweet`, and `_*` headline/data/context/takeaway helpers).